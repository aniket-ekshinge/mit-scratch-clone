...
const SpriteControls = () => {
  ...
  return (
    <div className="flex flex-col border-t-2 border-gray-200 bg-gray-100 p-2" style={{ flex: 0.4 }}>
      <div className="flex justify-between items-center mb-2">
        <p className="font-bold text-lg">Sprites</p>
        <div className="flex gap-2">
          <div className="flex items-center justify-between py-2 px-4 bg-pink-200 rounded-lg shadow-md">
          <label htmlFor="enableCollision" className="text--700 font-medium mr-4 inline-flex items-center space-x-2 bg-purple-400 px-4 py-2 rounded-lg shadow-sm hover:bg-purple-600 transition-colors duration-300">
            <span>Swap Actions On Collision</span>
            </label>
